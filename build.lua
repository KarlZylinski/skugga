...
if build then
    ...
    if #object_files > 0 then
        local link_cmd = "link.exe " .. extra_link_opts .. " /subsystem:windows /entry:mainCRTStartup dbghelp.lib d3d11.lib user32.lib dxgi.lib D3DCompiler.lib /out:skugga.exe " .. object_files
        run_or_die(link_cmd)
    end
end
