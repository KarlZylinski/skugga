...
if build then
    ...
    for _, filename in ipairs(files_to_build) do
        ...
        local build_cmd = "cl.exe /FI types.h /FI helpers.h /D _HAS_EXCEPTIONS=0 /nologo /DUNICODE /W4 /WX /Gm /EHsc /TP /wd4201 /wd4100 /c /D _CRT_SECURE_NO_WARNINGS /Zi /MTd " .. extra_compile_opts .. " /Fo" .. object_filename .. " " .. filename
